 ...
 * @suppress {checkTypes|uselessCode}
 */
zz.views.templates.default.model = function(opt_data, opt_ignored) {
  return '<div class="' + goog.getCssName('model') + '"></div>';
};
if (goog.DEBUG) {
  zz.views.templates.default.model.soyTemplateName = 'zz.views.templates.default.model';
}
