...
zz.views.templates.default.dataset = function(opt_data, opt_ignored) {
  return '<div class="' + goog.getCssName('dataset') + '" data-uid="' + soy.$$escapeHtml(opt_data.uid) + '"></div>';
};
if (goog.DEBUG) {
...
zz.views.templates.default.datarow = function(opt_data, opt_ignored) {
  return '<div class="' + goog.getCssName('datarow') + '" data-uid="' + soy.$$escapeHtml(opt_data.uid) + '"></div>';
};
if (goog.DEBUG) {
