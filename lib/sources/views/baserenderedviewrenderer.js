...
/**
 *
 * @param {zz.views.BaseRenderedView} view
 * @param {zz.models.Message} message
 */
zz.views.BaseRenderer.prototype.modelUpdated = function( view, message ){
 ...
 * @param {zz.models.Message} message
 */
zz.views.BaseRenderer.prototype.modelDeleted = function( view, message ){
 ...
 * @param {zz.models.Message} message
 */
zz.views.BaseRenderer.prototype.modelCreated = function( view, message ){
