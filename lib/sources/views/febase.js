...
zz.views.FEBase.prototype.setElementUid_ = function( model, controller, view ){
	...
	if( !this.getElementAttribute_( view, "data-uid" ) ){
		...
		if( uid = this.getElementAttribute_( view, "data-set" ) ){
			...
			//uid = goog.events.getUniqueId( uid ) + "::" + this.getElementAttribute_( view, "data-field" );
			uid = uid + "::" + this.getElementAttribute_( view, "data-field" );
			this.ram_.set( uid, model, controller, view, [
 ...
 * @returns {string}
 */
zz.views.FEBase.prototype.getElementValue = function( view ){
...
zz.views.FEBase.prototype.updateDatarow = function( message ){
	...
	if( item.view.value ){
		...
		goog.dom.setTextContent( item.view, message.new_value );
	}
};